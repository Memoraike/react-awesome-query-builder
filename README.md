...
[![npm](https://img.shields.io/npm/v/@react-awesome-query-builder-dev/ui.svg)](https://www.npmjs.com/package/@react-awesome-query-builder-dev/ui)
...
- [`@react-awesome-query-builder-dev/core`](/packages/core) - has core functionality to import/export/store query, provides utils
- [`@react-awesome-query-builder-dev/ui`](/packages/ui) - has core React components like `<Query>` `<Builder>` and CSS, provides config with basic (vanilla) widgets
- [`@react-awesome-query-builder-dev/antd`](/packages/antd) - provides config with [Ant Design](https://ant.design/) widgets
- [`@react-awesome-query-builder-dev/mui`](/packages/mui) - provides config with [MUI](https://mui.com/) widgets
- [`@react-awesome-query-builder-dev/material`](/packages/material) - provides config with [Material-UI v4](https://v4.mui.com/) widgets (deprecated)
- [`@react-awesome-query-builder-dev/bootstrap`](/packages/bootstrap) - provides config with [Bootstrap](https://reactstrap.github.io/) widgets
- [`@react-awesome-query-builder-dev/fluent`](/packages/fluent) - provides config with [Fluent UI](https://developer.microsoft.com/en-us/fluentui) widgets
...
// >>>
import { Utils as QbUtils, Query, Builder, BasicConfig } from '@react-awesome-query-builder-dev/ui';
import '@react-awesome-query-builder-dev/ui/css/styles.css';
// or import '@react-awesome-query-builder-dev/ui/css/compact_styles.css';
...
// >>> 
import type { JsonGroup, Config, ImmutableTree, BuilderProps } from '@react-awesome-query-builder-dev/ui';
import { Utils as QbUtils, Query, Builder, BasicConfig } from '@react-awesome-query-builder-dev/ui';
import '@react-awesome-query-builder-dev/ui/css/styles.css';
// or import '@react-awesome-query-builder-dev/ui/css/compact_styles.css';
const InitialConfig = BasicConfig;
...
### Import utils
  ...
  Requires import of `@react-awesome-query-builder-dev/sql`:  
...
### Save/load config from server
  ...
  It depends on UI framework you choose - eg. if you use `@react-awesome-query-builder-dev/mui`, please provide `MuiConfig` to `baseConfig`. 
...
```js
import { Utils as QbUtils, JsonSwitchGroup } from '@react-awesome-query-builder-dev/ui';
...
- [`@react-awesome-query-builder-dev/ui`](/packages/ui)
- [`@react-awesome-query-builder-dev/antd`](/packages/antd)
- [`@react-awesome-query-builder-dev/bootstrap`](/packages/bootstrap)
- [`@react-awesome-query-builder-dev/mui`](/packages/mui)
- [`@react-awesome-query-builder-dev/material`](/packages/material) (deprecated)
- [`@react-awesome-query-builder-dev/fluent`](/packages/fluent)
...
+ import { Utils, Export, Import, BasicFuncs } from '@react-awesome-query-builder-dev/ui';

- import { Query, Builder, BasicConfig, Widgets, Operators } from 'react-awesome-query-builder';
+ import { Query, Builder, BasicConfig, VanillaWidgets, CustomOperators } from '@react-awesome-query-builder-dev/ui';
...
+ import '@react-awesome-query-builder-dev/ui/css/compact_styles.css'; // instead of styles.css for more compact look
```

Note that you should import all types and values from a single package.
For example, `@react-awesome-query-builder-dev/antd` if you use AntDesign - it inherits `core` and `ui`:
```js
import {Utils, Query, Builder, AntdConfig} from '@react-awesome-query-builder-dev/antd';
```
...
If you use vanilla widgets, please install, import and use only `@react-awesome-query-builder-dev/ui` (it inherits `core`). 
