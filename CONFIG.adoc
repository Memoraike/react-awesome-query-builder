...
[source,javascript]
----
import {CustomOperators: {ProximityOperator}} from '@react-awesome-query-builder-dev/ui';
----
...
[source,javascript]
----
import {VanillaWidgets} from '@react-awesome-query-builder-dev/ui';
import {AntdWidgets} from '@react-awesome-query-builder-dev/antd';
import {MuiWidgets} from '@react-awesome-query-builder-dev/mui';
import {MaterialWidgets} from '@react-awesome-query-builder-dev/material'; // MUI v4
...
[source,javascript]
----
import { BasicFuncs } from '@react-awesome-query-builder-dev/ui';
const config = {
  //...
  funcs: {
