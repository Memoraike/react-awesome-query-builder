# @react-awesome-query-builder-dev/sandbox

[![npm](https://img.shields.io/npm/v/@react-awesome-query-builder-dev/sandbox.svg)](https://www.npmjs.com/package/@react-awesome-query-builder-dev/sandbox)
