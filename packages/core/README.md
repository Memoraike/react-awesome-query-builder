...
[![npm](https://img.shields.io/npm/v/@react-awesome-query-builder-dev/core.svg)](https://www.npmjs.com/package/@react-awesome-query-builder-dev/core)
...
```
npm i @react-awesome-query-builder-dev/core --save
```
