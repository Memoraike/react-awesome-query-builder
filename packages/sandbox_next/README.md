# @react-awesome-query-builder-dev/sandbox-next

[![npm](https://img.shields.io/npm/v/@react-awesome-query-builder-dev/sandbox-next.svg)](https://www.npmjs.com/package/@react-awesome-query-builder-dev/sandbox-next)
...
In first case local `@react-awesome-query-builder-dev/*` packages will be used.  
In second case `@react-awesome-query-builder-dev/*` packages will be downloaded from NPM.  
...
- based on `CoreConfig` (imported from `@react-awesome-query-builder-dev/core`)
