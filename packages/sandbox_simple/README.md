# @react-awesome-query-builder-dev/sandbox-simple

[![npm](https://img.shields.io/npm/v/@react-awesome-query-builder-dev/sandbox-simple.svg)](https://www.npmjs.com/package/@react-awesome-query-builder-dev/sandbox-simple)
